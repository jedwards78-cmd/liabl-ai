      ...
      <div className="max-w-4xl mx-auto px-4 py-14">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-base max-w-xl mx-auto leading-relaxed mb-6">
            Plans are based on features and monthly signature volume — not per-waiver fees.
          ...
          {TIERS.map(t => {
            ...
            return (
              <div key={t.id} className={`rounded-2xl border p-6 flex flex-col ${
                ...
                {t.highlight && (
                  <div className="text-xs font-semibold tracking-widest uppercase mb-3 text-white/60">Most popular</div>
                )}
        ...
        <div className="bg-brand/5 border border-brand/20 rounded-xl p-4 mb-8">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-semibold text-ink text-sm mb-1">Need more signatures?</div>
              <div className="text-xs text-gray-500 leading-relaxed">
                Core supports 500/month · Connected supports 2,500/month · Intelligence supports 20,000/month.
                High-volume operators and enterprise deployments can contact us for custom volume pricing.
                All plans include <strong>unlimited participants</strong> — you never pay per person.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-ink rounded-2xl p-6 text-white">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">Custom signature volume, SSO, SCIM, dedicated support, multi-location reporting, and volume pricing.</p>
            <div className="space-y-1.5 mb-5">
              {['Custom signature volume','SSO + SCIM provisioning','Dedicated support & SLA','Multi-location reporting','Custom retention policies'].map(f => (
          ...
          <div className="bg-brand/5 border border-brand/20 rounded-2xl p-6">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-4">Embed LIABL under your own brand. Full UI white-labeling, custom domain, platform-level API, and revenue share.</p>
            <div className="space-y-1.5 mb-5">
        ...
        <div className="mt-10 bg-white rounded-2xl border border-black/10 p-5">
          <div className="text-sm font-semibold text-ink mb-3">How LIABL compares to per-waiver pricing</div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            {[
              ...
              { name:'LIABL Core',   model:'$49/month · 500 included', note:"Flat rate. Upgrade when you need more volume or features." },
            ].map(c => (
