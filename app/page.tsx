...
import { IconSigned, IconLIABLPass, IconRiskProfile, IconAuditTrail, IconIntegration, IconLegalHold, IconDocumentIntelligence, IconNetwork } from '@/components/icons'

const TILES = [
  { href:'/participant', label:'Waivers That Build Themselves',          sub:'See the document adapt in real time',       bg:'#4B2ACF', Icon:IconSigned             },
  { href:'/portal',      label:'A Participant Profile That Remembers',   sub:'Cross-operator identity & history',         bg:'#0891B2', Icon:IconLIABLPass          },
  { href:'/operator',    label:'Know Before They Show Up',               sub:'AI risk intelligence at check-in',          bg:'#059669', Icon:IconRiskProfile        },
  { href:'/groups',      label:'Groups That Sign Before They Arrive',    sub:'Pre-arrival signing & manifest sync',       bg:'#7C3AED', Icon:IconDocumentIntelligence },
  { href:'/integrations','label':'Connected to Everything You Already Use',sub:'FareHarbor, Rezdy, SSO & insurance',    bg:'#D97706', Icon:IconIntegration        },
  { href:'/security',    label:'A Legal Record That Holds Up in Court',  sub:'Audit trail, integrity & compliance',       bg:'#DC2626', Icon:IconLegalHold          },
  { href:'/pricing',     label:'Built for Every Stage of Growth',        sub:'Feature-based plans from $49/mo',           bg:'#0D9488', Icon:IconAuditTrail         },
  { href:'/why',         label:'The Market Window — and Why It\'s Now',  sub:'Market case & investor overview',           bg:'#BE185D', Icon:IconNetwork            },
]
