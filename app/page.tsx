...
// ── Item 1: Each tile gets its own colour ─────────────────────
const TILES = [
  { href:'/participant', Icon:FileSignature,   label:'Sign a waiver',        sub:'Participant flow',               bg:'#4B2ACF' }, // brand indigo
  { href:'/portal',      Icon:UserCircle,      label:'Participant portal',    sub:'Profile & waiver history',       bg:'#0891B2' }, // cyan
  { href:'/operator',    Icon:LayoutDashboard, label:'Operator dashboard',    sub:'Roster, analytics & templates',  bg:'#059669' }, // emerald
  { href:'/groups',      Icon:Users,           label:'Group reservations',    sub:'Manage group bookings',          bg:'#7C3AED' }, // violet
  { href:'/integrations',Icon:Plug,            label:'Integrations',          sub:'FareHarbor, Rezdy & SSO',        bg:'#D97706' }, // amber
  { href:'/security',    Icon:ShieldCheck,     label:'Security & Enterprise', sub:'Audit, compliance & RBAC',       bg:'#DC2626' }, // red
  { href:'/pricing',     Icon:CreditCard,      label:'Pricing',               sub:'Plans & enterprise options',     bg:'#0D9488' }, // teal
  { href:'/why',         Icon:TrendingUp,      label:'Why LIABL · Why now',   sub:'Market case & investor overview',bg:'#BE185D' }, // pink
]

// ── Item 4: Each operator gets a unique icon + full name ──────
const OPERATORS = [
  {
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-surface">
      ...
      {/* ── Item 4: White-label demo — unique icon + full name ── */}
      <section className="px-6 py-10 bg-white border-y border-black/8">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Toggle between operators to see how the experience adapts.
              </p>
            </div>
          ...
          <div className="bg-surface rounded-2xl border border-black/10 overflow-hidden">
            ...
            {/* Simulated entry screen */}
            <div className="px-6 py-10 max-w-sm mx-auto text-center">
              {/* ── Item 4: Unique icon per operator ── */}
