...
const FORCES = [
  {
    num:'01', icon:'🏔', title:'Activity industry growth', sub:'The market is expanding faster than the tooling',
    color:'text-brand', bg:'bg-brand/5 border-brand/20',
    ...
    body:`US outdoor recreation grew 24% between 2020 and 2024. New operators are entering markets that didn't exist five years ago — urban climbing gyms, urban paddleboard rentals, e-bike tours, cold plunge studios.\n\nThese operators are digitally native with no legacy waiver infrastructure. They're greenfield customers who will adopt whatever the default document solution is for their vertical — and right now, there is no clear default.\n\nOperators who survived and grew are now professionalising. They're moving from paper clipboards to digital rosters, looking for a purpose-built solution rather than a general e-sign tool awkwardly adapted to their use case.`,
  },
  {
    num:'02', icon:'⚖️', title:'Rising liability exposure', sub:'Operators know a bad waiver is worse than no waiver',
    color:'text-amber-600', bg:'bg-amber-50 border-amber-200',
    stats:[{value:'+31%',label:'Recreation-related injury suits 2019–2024'},{value:'$4.2M',label:'Average recreation liability settlement (2024)'},{value:'67%',label:'Of dismissed suits cite inadequate documentation'}],
    body:`Recreation-related personal injury suits increased 31% between 2019 and 2024. Operators are increasingly aware that a poorly documented waiver creates false confidence while failing in court.\n\nCourts now distinguish between waivers that were signed but not understood (single-page PDF, 8pt font) and waivers that were read, activity-specific, and clearly accepted. LIABL's clause read-through tracking, adaptive specificity, and audit trail directly address the documentation standards courts are applying.\n\nInsurance carriers are beginning to ask about waiver quality as part of underwriting — creating a B2B2C motion where insurers recommend LIABL-standard documentation.`,
  },
  {
    num:'03', icon:'🔌', title:'Booking platform API maturity', sub:'The integration layer just became capable of supporting LIABL',
    color:'text-emerald-600', bg:'bg-emerald-50 border-emerald-200',
    stats:[{value:'2021–2024',label:'FareHarbor, Rezdy, Xola, Bókun REST API launches'},{value:'4 platforms',label:'With bidirectional webhook support as of 2024'},{value:'180K+',label:'Operators on FareHarbor alone'}],
    body:`FareHarbor, Rezdy, Xola, and Bókun all launched or significantly expanded their REST APIs between 2021 and 2024. The technical infrastructure for bidirectional booking-waiver sync didn't exist at sufficient quality before this window.\n\nLIABL's Group Reservations feature — pre-arrival signing, real-time manifest sync, waiver status flowing back to the booking platform — only works if the booking platforms have APIs capable of supporting it. They now do.\n\nThe 180,000+ operators on FareHarbor represent a distribution channel, not a sales challenge. A single FareHarbor integration surfaces LIABL to every FareHarbor operator at their moment of highest relevance: when a booking is confirmed.`,
  },
]
    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="bg-ink text-white px-6 py-14 text-center">
        <p className="text-xs font-semibold tracking-widest uppercase mb-4" style={{ color:'#A78BFA' }}>
          {tab === 'why' ? 'Market thesis' : 'Investor overview'}
        </p>
        ...
        <p className="text-gray-400 text-base max-w-xl mx-auto leading-relaxed">
          {tab === 'why'
            ? "Activity industry growth, rising liability exposure, and booking platform API maturity have created a moment that didn't exist three years ago — and won't last three more."
            : "An interactive walkthrough of LIABL's market position, adaptive document intelligence, and the network effect thesis — designed for investor conversations."}
        </p>
      </div>
          ...
          <div className="space-y-12">
                  ...
                  <div key={f.num} className="bg-white rounded-2xl border border-black/10 overflow-hidden">
                    <div onClick={() => setExpanded(expanded === f.num ? null : f.num)}
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-base text-ink flex items-center gap-2 mb-0.5">
            ...
            <div className="bg-brand rounded-2xl p-6 text-white">
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-5">
                Any competitor can build adaptive waivers. Nobody can buy five years of signed participant data across thousands of operators. The identity graph — every participant&apos;s verified history across every LIABL-connected activity — is the asset that makes LIABL defensible. At 5,000 operators, a new operator inherits 68% participant recognition on day one.
              </p>
        ...
        {tab === 'investor' && (
          <div className="space-y-14">
            ...
            <section>
              ...
              <h2 className="font-serif text-2xl text-ink mb-3 max-w-xl" style={{ letterSpacing:'-0.01em' }}>
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-2xl">
                DocuSign and Adobe own enterprise e-signature. Smartwaiver and Wherewolf own activity check-in. Neither side owns the white space between them. That is where LIABL is built.
              </p>
              ...
              <div className="bg-brand/5 border border-brand/20 rounded-xl p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500 leading-relaxed">New entrants cannot replicate LIABL&apos;s position — the participant identity graph requires years of signed documents to become defensible. The network effect is the moat.</div>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <h2 className="font-serif text-2xl text-ink mb-6" style={{ letterSpacing:'-0.01em' }}>What LIABL builds — and why now.</h2>
            ...
            <section className="bg-white rounded-2xl border border-black/10 p-6">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-2xl">
                The document builds itself from participant answers in real time. A cardiac condition triggers fundamentally different risk language and a new medical indemnification clause. Try it below.
              </p>
              <AdaptiveDemo />
            </section>

            {/* Feature 05 network simulator */}
            <section className="bg-ink rounded-2xl p-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-2xl">
                Each operator that joins LIABL increases the recognition rate for every other operator. Drag the slider to see the flywheel in motion.
              </p>
              <NetworkDemo />
            </section>
          </div>
