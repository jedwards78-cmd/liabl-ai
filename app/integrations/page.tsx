...
type Tab = 'platforms' | 'sso' | 'insurance' | 'webhooks' | 'apikeys' | 'eventlog'
...
export default function IntegrationsPage() {
  ...
  const tabs:[Tab,string][]=[['platforms','Platforms'],['sso','Identity & SSO'],['insurance','🛡 Insurance'],['webhooks','Webhooks'],['apikeys','API keys'],['eventlog','Event log']]
  return (
    <div className="min-h-screen bg-surface">
      <nav className="bg-white border-b border-black/10 px-5 py-3 flex items-center justify-between"><Logo size="md"/><span className="text-xs bg-surface border border-black/10 px-3 py-1.5 rounded-full text-gray-500">Integrations</span></nav>
