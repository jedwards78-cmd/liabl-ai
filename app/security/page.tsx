...
export default function SecurityPage() {
  ...
  const BANNERS: Record<Tab,{eyebrow:string;title:string;sub:string}> = {
    security: {
      ...
      sub:    'Every LIABL document is immutably hashed at signing time. Every event is logged with millisecond precision, IP address, device fingerprint, and chain of custody.',
    },
    enterprise: {
      ...
      <div className="bg-white border-b border-black/10 px-5">
        <div className="flex gap-0 max-w-3xl mx-auto">
          {([
            ...
            { key:'enterprise', label:'🏢 Enterprise features' },
