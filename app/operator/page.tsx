...
const DEMO: WaiverRow[] = [
  { id:'1', signed_at:'2026-05-26T08:42:00Z', activity_key:'kayak', is_minor:false, participants:{ full_name:'Jordan Rivera',  email:'j.rivera@email.com' } },
  { id:'2', signed_at:'2026-05-26T08:51:00Z', activity_key:'hike',  is_minor:true,  participants:{ full_name:'Mia Chen',       email:'mia@email.com' } },
  { id:'3', signed_at:'2026-05-26T08:53:00Z', activity_key:'atv',   is_minor:false, participants:{ full_name:'Tyler Brooks',   email:'tyler@email.com' } },
  { id:'4', signed_at:null,                   activity_key:'climb',  is_minor:false, participants:{ full_name:'Sasha Kim',     email:'sasha@email.com' } },
  { id:'5', signed_at:'2026-05-26T08:58:00Z', activity_key:'kayak', is_minor:false, participants:{ full_name:'Omar Hassan',    email:'omar@email.com' } },
  { id:'6', signed_at:'2026-05-26T09:02:00Z', activity_key:'atv',   is_minor:false, participants:{ full_name:'Priya Nair',     email:'priya@email.com' } },
  { id:'7', signed_at:null,                   activity_key:'hike',   is_minor:false, participants:{ full_name:'Lucas West',     email:'lucas@email.com' } },
  { id:'8', signed_at:'2026-05-26T09:05:00Z', activity_key:'climb',  is_minor:false, participants:{ full_name:'Anya Sharma',   email:'anya@email.com' } },
  { id:'9', signed_at:null,                   activity_key:'hike',   is_minor:false, participants:{ full_name:'Casey Morgan',   email:'casey@email.com' } },
]
...
const BG = ['#E6F1FB','#E1F5EE','#EEEDFE','#FAEEDA','#FBEAF0','#EAF3DE']
const FG = ['#185FA5','#0F6E56','#534AB7','#854F0B','#993556','#3B6D11']
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">
              Desert Ridge Adventures · {new Date().toLocaleDateString('en-US', { weekday:'long', month:'long', day:'numeric' })}
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-black/10 overflow-hidden">
          ...
          {loading ? (
            ...
            const time = w.signed_at
              ? new Date(w.signed_at).toLocaleTimeString([], { hour:'2-digit', minute:'2-digit' })
              : '—'
            return (
              <div key={w.id} className="flex items-center gap-3 px-4 py-3 border-b border-black/5 last:border-0 hover:bg-surface/60 transition-colors">
                ...
                : w.signed_at  ? <span className="status-signed   shrink-0">Signed</span>
