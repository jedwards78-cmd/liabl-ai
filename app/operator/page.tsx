...
import {
  ...
  IconAuditTrail, IconLocation, IconRocket, IconMobile,
} from '@/components/icons'

type Tab = 'roster'|'analytics'|'templates'|'incidents'|'notifications'|'multilocation'|'onboarding'|'mobile'
...
export default function OperatorPage() {
  ...
  const tabs: { key:Tab; label:string; Icon: React.ComponentType<{size?:number;color?:string}> }[] = [
    ...
    { key:'onboarding',    label:'Get Started',    Icon: IconRocket     },
