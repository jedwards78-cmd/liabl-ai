    ...
    <div className="space-y-8">
      ...
      <div className="bg-brand/5 border border-brand/20 rounded-2xl p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          {[
            {
              icon:'💰', title:'15–20% revenue share',
            ...
            {
              icon:'🔒', title:'34% lower operator churn',
              desc:'Operators who use an embedded waiver tool churn at 34% lower rates than operators who use an external tool. The integration creates meaningful switching cost — your platform becomes the hub for their compliance workflow, not just their bookings.',
              badge:'34% churn reduction',
              color:'text-blue-700 bg-blue-50 border-blue-200',
            },
            {
              icon:'🏗️', title:'$400K–$800K build cost avoided',
              desc:'Building a comparable waiver system in-house — adaptive documents, e-signature compliance, participant identity graph, insurance integrations — costs $400K–$800K in engineering and $120K/yr to maintain. White-labeling LIABL eliminates that entirely.',
              badge:'$400K–800K saved',
              color:'text-brand bg-brand/10 border-brand/20',
            },
            {
              icon:'📈', title:'Insurance upsell surface',
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          { icon:'🎨', title:'Full UI white-labeling',    desc:'Every participant-facing screen inherits the operator\'s brand color, icon, and name. The LIABL mark appears only as "Secured by LIABL" in the footer.' },
