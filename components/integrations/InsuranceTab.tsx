...
const CARRIERS = [
  {
    id:'kk', name:'K&K Insurance', logo:'🛡️', specialty:'Outdoor & adventure activities', connected:true, since:'Connected Apr 2026',
  ...
  {
    id:'markel', name:'Markel Specialty', logo:'🏛️', specialty:'Recreation & sports liability', connected:true, since:'Connected Feb 2026',
  ...
  {
    id:'phly', name:'Philadelphia Insurance', logo:'🏢', specialty:'Youth sports & camps', connected:false, since:null,
    outbound:[], inbound:[], incidentWebhook:false,
  },
  {
    id:'cna', name:'CNA Financial', logo:'🔵', specialty:'Enterprise & multi-location', connected:false, since:null,
    outbound:[], inbound:[], incidentWebhook:false,
  },
  {
    id:'berkley', name:'W.R. Berkley', logo:'🟦', specialty:'Fitness & wellness facilities', connected:false, since:null,
    outbound:[], inbound:[], incidentWebhook:false,
  },
]
