  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-white rounded-2xl border border-black/10 p-5"><div className="text-sm font-semibold text-ink mb-1">⚡ AI Risk score distribution</div><div className="text-xs text-gray-400 mb-3">All participants this {period}</div><DonutChart data={RISK_DIST}/></div>
      </div>
