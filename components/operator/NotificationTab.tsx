...
const TYPE_CONFIG: Record<NotifType, { icon:string; color:string; bg:string; label:string }> = {
  waiver_signed:    { icon:'✍️', color:'text-emerald-700', bg:'bg-emerald-50',  label:'Waiver signed'       },
  exception_flagged:{ icon:'⚠️', color:'text-amber-700',   bg:'bg-amber-50',    label:'Exception'           },
  legal_hold:       { icon:'🔒', color:'text-red-700',     bg:'bg-red-50',      label:'Legal hold'          },
  carrier_notified: { icon:'📡', color:'text-blue-700',    bg:'bg-blue-50',     label:'Carrier notified'    },
  group_complete:   { icon:'✅', color:'text-emerald-700', bg:'bg-emerald-50',  label:'Group complete'      },
  overage_warning:  { icon:'📊', color:'text-orange-700',  bg:'bg-orange-50',   label:'Usage alert'         },
  pass_recognized:  { icon:'✦',  color:'text-brand',       bg:'bg-brand/10',    label:'LIABL Pass'          },
}
