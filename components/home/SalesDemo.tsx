    ...
    return (
      <div className="text-center animate-fade-up">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8 max-w-xl mx-auto">
          <Link href="/pricing"  className="card hover:shadow-md transition-shadow text-center py-4"><div className="text-2xl mb-2">💳</div><div className="font-semibold text-ink text-sm">Show Pricing</div><div className="text-xs text-gray-400">Plans from $49/mo</div></Link>
          <Link href="/why"      className="card hover:shadow-md transition-shadow text-center py-4"><div className="text-2xl mb-2">📈</div><div className="font-semibold text-ink text-sm">Investor Overview</div><div className="text-xs text-gray-400">Market thesis & demos</div></Link>
          <Link href="/"         className="card hover:shadow-md transition-shadow text-center py-4"><div className="text-2xl mb-2">🏠</div><div className="font-semibold text-ink text-sm">Full Prototype</div><div className="text-xs text-gray-400">Explore all features</div></Link>
        </div>
    ...
    <div>
      ...
      <div className="card mb-4 animate-fade-up" key={step}>
        ...
        <div className="bg-brand/5 border border-brand/20 rounded-xl p-4 mb-5 flex gap-3 items-start">
          <span className="text-brand shrink-0 mt-0.5 text-lg">💡</span>
          <div>
